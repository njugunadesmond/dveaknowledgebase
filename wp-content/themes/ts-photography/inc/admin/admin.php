...
function ts_photography_abouttheme() {    	
	add_theme_page( esc_html__('About Ecommerce Theme', 'ts-photography'), esc_html__('About Photography Theme', 'ts-photography'), 'edit_theme_options', 'ts_photography_guide', 'ts_photography_mostrar_guide');   
}
...
?>
 <div class="wrapper-info">
	...
	<button class="tablink" onclick="openPage('Contact', this, '')"><?php esc_html_e('Premium Theme info', 'ts-photography'); ?>Plugin</button>
	</div>
