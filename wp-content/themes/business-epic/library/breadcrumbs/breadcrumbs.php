...
/**
 * Shows a breadcrumb for all types of pages.  This is a wrapper function for the business_epic_breadcrumb_trail class,
 * which should be used in theme templates.
 *
 * @since  0.1.0
 * @access public
 * @param  array $args Arguments to pass to business_epic_breadcrumb_trail.
 * @return void
 */
function business_epic_breadcrumb_trail( $args = array() ) {

    $breadcrumb = apply_filters( 'business_epic_breadcrumb_trail_object', null, $args );

    if ( !is_object( $breadcrumb ) )
        $breadcrumb = new business_epic_breadcrumb_trail( $args );
 ...
 * @access public
 */
class business_epic_breadcrumb_trail {
    ...
    /**
     * Sets up the breadcrumb trail properties.  Calls the `business_epic_breadcrumb_trail::add_items()` method
     ...
     *     @type array     $labels         Text labels. @see business_epic_breadcrumb_trail::set_labels()
     *     @type array     $post_taxonomy  Taxonomies to use for post types. @see business_epic_breadcrumb_trail::set_post_taxonomy()
    ...
    public function __construct( $args = array() ) {
        ...
        $this->args = apply_filters( 'business_epic_breadcrumb_trail_args', wp_parse_args( $args, $defaults ) );
    ...
    public function trail() {
        ...
        $breadcrumb = apply_filters( 'business_epic_breadcrumb_trail', $breadcrumb, $this->args );
    ...
    protected function set_labels() {
        ...
        $this->labels = apply_filters( 'business_epic_breadcrumb_trail_labels', wp_parse_args( $this->args['labels'], $defaults ) );
    }
    ...
    protected function set_post_taxonomy() {
        ...
        $this->post_taxonomy = apply_filters( 'business_epic_breadcrumb_trail_post_taxonomy', wp_parse_args( $this->args['post_taxonomy'], $defaults ) );
    }
    ...
    protected function add_items() {
        ...
        $this->items = array_unique( apply_filters( 'business_epic_breadcrumb_trail_items', $this->items, $this->args ) );
    }
